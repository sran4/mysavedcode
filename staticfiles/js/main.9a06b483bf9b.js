...
function displaySearching() {
  ...
  serchButton.html("<i class='fa fa-spin fa-spinner fa-1px text-light' style='border-radius: 6px;font-size:8px; color:white;'></i> Searching...")
}
...
function displaySearching1() {
  ...
  serchButton1.html("<i class='fa fa-spin fa-spinner fa-1x text-light' style='border-radius: 6px;font-size:8px; color:white;'></i> Searching...")
}
