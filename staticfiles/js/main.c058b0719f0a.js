...
function displaySearching() {
  ...
  serchButton.html("<i class='fa fa-spin fa-spinner fa-3px text-light' style='border-radius: 6px; font-size:16px; color:white;'></i> Searching...")
}
...
function displaySearching1() {
  ...
  serchButton1.html("<i class='fa fa-spin fa-spinner fa-3x text-light' style='border-radius: 6px;font-size:16px; color:white;'></i> Searching...")
}
